...
var dealSound = new Audio("sounds/deal.wav");
var draw2Sound = new Audio("sounds/draw2.wav");
var draw4Sound = new Audio("sounds/draw4.wav");
var placeSound = new Audio("sounds/place.wav");
...
var wildSound = new Audio("sounds/wild.wav");
...
function doSomething() {
    ...
    if (card.value == "reverse") {
        reverseSound.play();
        alert("The order of turns has been reversed.");
        if (players.length == 2) {
            switchTurn();
            alert("Thanks to the reverse, " + players[turn].name + " is skipped.");
            switchTurn();
        } // End nested if.
        else {
            move *= -1;
        ...
        switchTurn();
        skipSound.play();
        alert(players[turn].name + " is skipped.");
        switchTurn();
    } // End else if.
